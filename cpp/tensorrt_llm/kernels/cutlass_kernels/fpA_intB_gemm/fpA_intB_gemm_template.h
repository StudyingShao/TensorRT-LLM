    ...
    char* workspace_ptr, const size_t workspace_bytes, cudaStream_t stream, int* occupancy)
{
    ...
    {
        using OutputType_ = typename cutlass::platform::conditional<
            cutlass::platform::is_same<ActivationType, __nv_fp8_e4m3>::value, half, OutputType>::type;
        using BiasType_ = typename cutlass::platform::conditional<
            cutlass::platform::is_same<ActivationType, __nv_fp8_e4m3>::value, half, BiasType>::type;
        using ScaleZeroType_ = typename cutlass::platform::conditional<
            cutlass::platform::is_same<ActivationType, __nv_fp8_e4m3>::value, OutputType_, ScaleZeroType>::type;
    
        ScaleZeroType_* weight_scales_ = reinterpret_cast<ScaleZeroType_ *>(const_cast<ScaleZeroType*>(weight_scales));
        ScaleZeroType_* weight_zero_points_ = reinterpret_cast<ScaleZeroType_ *>(const_cast<ScaleZeroType*>(weight_zero_points));
        ...
        sm90_dispatch_gemm_to_cutlass<ActivationType, WeightType, ScaleZeroType_, BiasType_, OutputType_, QuantOp,
            EpilogueTag>(A, B, weight_scales_, weight_zero_points_, biases_, alpha, C_, m, n, k, group_size, workspace_ptr,
